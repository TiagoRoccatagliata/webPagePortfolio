...
const socialLinks = [
    {
        href: 'https://github.com/TiagoRoccatagliata',
    ...
    {
        href: 'https://www.linkedin.com/in/tiago-roccatagliata/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: 'https://www.instagram.com/tiagoroccatagliata/',
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        ¡Contáctame hoy para hablar sobre las necesidades de tu proyecto y empecemos a colaborar en algo increíble!
                    </p>
                ...
                <form
                    action="https://getform.io/f/arooleeb"
                    method="POST"
